...
/-! # DeanLean/LatexExtract.lean — Manifest entries → JSON for LaTeX/HTML/Verso
...
def main : IO Unit :=
  DeanLean.LatexExtract.run "LeanStats" "docs/manifest-index.json"
    #[{ module := `LeanStats }]
```
-/
...
namespace DeanLean.LatexExtract
