...
/-! # LeanManifests/LatexRoundtrip.lean — Verify a LaTeX file round-trips
...
def main : IO Unit := do
  ...
  match argv with
  | #[texFile, jsonFile] =>
    LeanManifests.LatexRoundtrip.run texFile jsonFile
  | _ =>
...
namespace LeanManifests.LatexRoundtrip
...
end LeanManifests.LatexRoundtrip
