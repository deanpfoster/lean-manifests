...
namespace LeanManifests.Tests.LibraryTameTests
...
end LeanManifests.Tests.LibraryTameTests

LibraryTame LeanManifests.Tests.LibraryTameTests.smokeRoot
...
the audit catches. To exercise the negative path manually:
  ...
  LibraryTame badRoot
-/
namespace LeanManifests.Tests.LibraryTameTests.NegativeCases
...
end LeanManifests.Tests.LibraryTameTests.NegativeCases
